...
/**
 * A library to talk to the Webkit Inspection Protocol (WIP).
 *
 * See the [WIP API docs](https://developers.google.com/chrome-developer-tools/docs/protocol/tot/index).
 */
...
class WipConnection {
  ...
  WipConnection(this._stream, this._streamSink) {
    ...
    _stream.listen((String data) {
      _JsonEvent event = new _JsonEvent._fromMap(JSON.decode(data));
